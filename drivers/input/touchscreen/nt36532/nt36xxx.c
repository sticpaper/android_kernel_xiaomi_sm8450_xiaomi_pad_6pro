...
/* FD workaround setup */
static void nvt_fw_fd_workaround(void);
/* FD workaround setup end */
...
static int32_t nvt_parse_dt(struct device *dev)
{
	...
	/* read id pin value, 0 is CSOT, 1 is TM */
	gpio_direction_input(ts->lcd_id_gpio);
	ts->lcd_id_value = gpio_get_value(ts->lcd_id_gpio);
	NVT_LOG("lcd_id_value = %d", ts->lcd_id_value);
	NVT_LOG("This panel is %s", ts->lcd_id_value ? "TM" : "CSOT");
...
static irqreturn_t nvt_ts_work_func(int irq, void *data)
{
	...
	if (touch_task == NULL) {
		/* touch prio improve */
		touch_task = current;
		NVT_LOG("touch_irq_thread prio improve to %d", MAX_RT_PRIO - 1);
...
//				last_touch_events_collect(PEN_INK_ID, !!pen_pressure);
...
//				last_touch_events_collect(PEN_HOVER_ID, !!pen_distance || !!pen_pressure);
			...
			input_report_abs(ts->pen_input_dev, ABS_DISTANCE, 0);
			input_report_key(ts->pen_input_dev, BTN_TOUCH, 0);
//			last_touch_events_collect(PEN_INK_ID, 0);
			input_report_key(ts->pen_input_dev, BTN_TOOL_PEN, 0);
//			last_touch_events_collect(PEN_HOVER_ID, 0);
		}
...
static void nvt_init_touchmode_data(void)
{
	...
	xiaomi_touch_interfaces.touch_mode[TOUCH_0][GET_MAX_VALUE] = 1;
	xiaomi_touch_interfaces.touch_mode[TOUCH_0][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_0][GET_DEF_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_0][SET_CUR_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_0][GET_CUR_VALUE] = 0;

	xiaomi_touch_interfaces.touch_mode[TOUCH_1][GET_MAX_VALUE] = 1;
	xiaomi_touch_interfaces.touch_mode[TOUCH_1][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_1][GET_DEF_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_1][SET_CUR_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_1][GET_CUR_VALUE] = 0;

	xiaomi_touch_interfaces.touch_mode[TOUCH_2][GET_MAX_VALUE] = 4;
	xiaomi_touch_interfaces.touch_mode[TOUCH_2][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_2][GET_DEF_VALUE] = 2;
	xiaomi_touch_interfaces.touch_mode[TOUCH_2][SET_CUR_VALUE] = 2;
	xiaomi_touch_interfaces.touch_mode[TOUCH_2][GET_CUR_VALUE] = 2;

	xiaomi_touch_interfaces.touch_mode[TOUCH_3][GET_MAX_VALUE] = 4;
	xiaomi_touch_interfaces.touch_mode[TOUCH_3][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_3][GET_DEF_VALUE] = 2;
	xiaomi_touch_interfaces.touch_mode[TOUCH_3][SET_CUR_VALUE] = 2;
	xiaomi_touch_interfaces.touch_mode[TOUCH_3][GET_CUR_VALUE] = 2;

	xiaomi_touch_interfaces.touch_mode[TOUCH_4][GET_MAX_VALUE] = 4;
	xiaomi_touch_interfaces.touch_mode[TOUCH_4][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_4][GET_DEF_VALUE] = 2;
	xiaomi_touch_interfaces.touch_mode[TOUCH_4][SET_CUR_VALUE] = 2;
	xiaomi_touch_interfaces.touch_mode[TOUCH_4][GET_CUR_VALUE] = 2;

	xiaomi_touch_interfaces.touch_mode[TOUCH_5][GET_MAX_VALUE] = 4;
	xiaomi_touch_interfaces.touch_mode[TOUCH_5][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_5][GET_DEF_VALUE] = 2;
	xiaomi_touch_interfaces.touch_mode[TOUCH_5][SET_CUR_VALUE] = 2;
	xiaomi_touch_interfaces.touch_mode[TOUCH_5][GET_CUR_VALUE] = 2;

	xiaomi_touch_interfaces.touch_mode[TOUCH_6][GET_MAX_VALUE] = 3;
	xiaomi_touch_interfaces.touch_mode[TOUCH_6][GET_MIN_VALUE] = 1;
	xiaomi_touch_interfaces.touch_mode[TOUCH_6][GET_DEF_VALUE] = 1;
	xiaomi_touch_interfaces.touch_mode[TOUCH_6][SET_CUR_VALUE] = 1;
	xiaomi_touch_interfaces.touch_mode[TOUCH_6][GET_CUR_VALUE] = 1;

	xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_MAX_VALUE] = 3;
	xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_DEF_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_8][SET_CUR_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_CUR_VALUE] = 0;

	xiaomi_touch_interfaces.touch_mode[TOUCH_7][GET_MAX_VALUE] = 3;
	xiaomi_touch_interfaces.touch_mode[TOUCH_7][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_7][GET_DEF_VALUE] = 2;
	xiaomi_touch_interfaces.touch_mode[TOUCH_7][SET_CUR_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_7][GET_CUR_VALUE] = 0;

	xiaomi_touch_interfaces.touch_mode[TOUCH_12][GET_MAX_VALUE] = 1;
	xiaomi_touch_interfaces.touch_mode[TOUCH_12][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_12][GET_DEF_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_12][SET_CUR_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_12][GET_CUR_VALUE] = 0;

	xiaomi_touch_interfaces.touch_mode[TOUCH_20][GET_MAX_VALUE] = 0x12;
	xiaomi_touch_interfaces.touch_mode[TOUCH_20][GET_MIN_VALUE] = -1;
	xiaomi_touch_interfaces.touch_mode[TOUCH_20][GET_DEF_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_20][SET_CUR_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_20][GET_CUR_VALUE] = 0;

	xiaomi_touch_interfaces.touch_mode[TOUCH_14][GET_MAX_VALUE] = 1;
	xiaomi_touch_interfaces.touch_mode[TOUCH_14][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_14][GET_DEF_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_14][SET_CUR_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_14][GET_CUR_VALUE] = 0;

	xiaomi_touch_interfaces.touch_mode[TOUCH_24][GET_MAX_VALUE] = 1;
	xiaomi_touch_interfaces.touch_mode[TOUCH_24][GET_MIN_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_24][GET_DEF_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_24][SET_CUR_VALUE] = 0;
	xiaomi_touch_interfaces.touch_mode[TOUCH_24][GET_CUR_VALUE] = 0;
...
static void update_touchfeature_value_work(struct work_struct *work) {
	...
	int size = 6;
	enum MODE_TYPE mode_type[6] = {TOUCH_0, TOUCH_2, TOUCH_3, TOUCH_5,
				TOUCH_4, TOUCH_7};
	...
	/* orientation set */
	temp_get_value = xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_CUR_VALUE];
	temp_set_value = xiaomi_touch_interfaces.touch_mode[TOUCH_8][SET_CUR_VALUE];
	if (temp_get_value != temp_set_value) {
		...
		xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_CUR_VALUE] = temp_set_value;
		NVT_LOG("set mode:%d = %d", TOUCH_8, temp_set_value);
	}

	/* RF set */
	temp_get_value = xiaomi_touch_interfaces.touch_mode[TOUCH_12][GET_CUR_VALUE];
	temp_set_value = xiaomi_touch_interfaces.touch_mode[TOUCH_12][SET_CUR_VALUE];
	if (temp_get_value != temp_set_value) {
		if (temp_set_value == 0) {
		...
		xiaomi_touch_interfaces.touch_mode[TOUCH_12][GET_CUR_VALUE] = temp_set_value;
		NVT_LOG("set mode:%d = %d", TOUCH_12, temp_set_value);
	}
	NVT_LOG("exit");
}
...
{
	NVT_LOG("value:%d", value);
	if (ts->ic_state <= NVT_IC_RESUME_IN && ts->ic_state != NVT_IC_INIT ) {
		ts->gesture_command_delayed = value;
		NVT_LOG("Panel off, don't set gesture_command until panel on, ic_state is %d", ts->ic_state);
	} else if (ts->ic_state >= NVT_IC_RESUME_OUT){
		ts->gesture_command = value;
		NVT_LOG("Panel on, set gesture_command, ic_state is %d", ts->ic_state);
	//	dsi_panel_doubleclick_enable(!!ts->gesture_command);
	}

	NVT_LOG("gesture_command is %d", ts->gesture_command);
}
...
int update_pen_status(bool enforce_send_cmd) {
	...
	NVT_LOG("pen_bluetooth_connect is %d, pen_charge_connect is %d, game_mode_enable is %d, %s pen input device\n"
				, ts->pen_bluetooth_connect, ts->pen_charge_connect, ts->game_mode_enable, enable ? "ENABLE" : "DISABLE");
	if(enable_last_time == enable) {
		if(!enforce_send_cmd) {
			NVT_LOG("enable_last_time = %d, enable = %d, enforce_send_cmd = %d, skip update", enable_last_time, enable, enforce_send_cmd);
			goto nvt_set_pen_enable_out;
		} else {
			NVT_LOG("enable_last_time = %d, enable = %d, enforce_send_cmd = %d, enforce send cmd", enable_last_time, enable, enforce_send_cmd);
		}
	}
	//---set xdata index to EVENT BUF ADDR---
	ret = nvt_set_page(ts->mmap->EVENT_BUF_ADDR | EVENT_MAP_HOST_CMD);
...
static int nvt_set_cur_value(int nvt_mode, int nvt_value)
{
	...
	if (nvt_mode == TOUCH_14 && ts && nvt_value >= 0) {
		nvt_set_gesture_mode(nvt_value ? (ts->gesture_command | 0x01) : (ts->gesture_command & 0xFE));
		return 0;
	}

	if (nvt_mode == TOUCH_20 && ts) {
		if (!!(nvt_value >> 4)) {
			/* connect logic */
			if((nvt_value & 0x0F) == 2){
				ts->pen_count ++ ;
		...
		nvt_set_gesture_mode((xiaomi_touch_interfaces.touch_mode[TOUCH_24][SET_CUR_VALUE] & ts->pen_bluetooth_connect) ? (ts->gesture_command | 0x02) : (ts->gesture_command & 0xFD));
		NVT_LOG("nvt_value is %d, pen_bluetooth_connect is %d, pen_count is %d", nvt_value, ts->pen_bluetooth_connect, ts->pen_count);
		update_pen_status(false);
		release_pen_event();
		return 0;
	}

	if (nvt_mode == TOUCH_24)
		nvt_set_gesture_mode((nvt_value & ts->pen_bluetooth_connect) ? (ts->gesture_command | 0x02) : (ts->gesture_command & 0xFD));

	if (nvt_mode == TOUCH_6) {
		NVT_LOG("This is Expert Mode, mode is %d", nvt_value);
		xiaomi_touch_interfaces.touch_mode[TOUCH_2][SET_CUR_VALUE] =
			ts->gamemode_config[nvt_value - 1][0];
		xiaomi_touch_interfaces.touch_mode[TOUCH_3][SET_CUR_VALUE] =
			ts->gamemode_config[nvt_value - 1][1];
		xiaomi_touch_interfaces.touch_mode[TOUCH_4][SET_CUR_VALUE] =
			ts->gamemode_config[nvt_value - 1][2];
		xiaomi_touch_interfaces.touch_mode[TOUCH_5][SET_CUR_VALUE] =
			ts->gamemode_config[nvt_value - 1][3];
		xiaomi_touch_interfaces.touch_mode[TOUCH_7][SET_CUR_VALUE] =
...
{
	xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_CUR_VALUE] =
		xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_DEF_VALUE];
...
static void nvt_all_para_recovery(void)
{
	...
	if(ts->game_mode_enable == 1)
	{
		...
		xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_CUR_VALUE] =
			xiaomi_touch_interfaces.touch_mode[TOUCH_8][GET_DEF_VALUE];
		xiaomi_touch_interfaces.touch_mode[TOUCH_12][GET_CUR_VALUE] =
			xiaomi_touch_interfaces.touch_mode[TOUCH_12][GET_DEF_VALUE];
	}
...
static ssize_t  nvt_touch_test_write(struct file *file, const char __user *buf,
	...
	NVT_LOG("%s set touch debug flag to %d\n", __func__, ts->debug_flag);
	retval = count;
out:
	return retval;
}
...
static int nvt_pinctrl_init(struct nvt_ts_data *nvt_data)
{
	...
	nvt_data->pinctrl_state_active
		= pinctrl_lookup_state(nvt_data->ts_pinctrl, "default");
	...
	nvt_data->pinctrl_state_suspend
		= pinctrl_lookup_state(nvt_data->ts_pinctrl, "sleep");
...
{
	struct sched_param par = { .sched_priority = MAX_RT_PRIO -1 };// prio -> 99
	int32_t ret = 0;
#if defined(CONFIG_DRM_PANEL)
	...
	if(client->controller) {
		NVT_LOG("controller kworker thread PID is %d, set thread RTPRIO to 99", client->controller->kworker->task->pid);
		ret = sched_setscheduler_nocheck(client->controller->kworker->task, SCHED_FIFO, &par);
		if(ret < 0) {
			NVT_ERR("Failed to improve SPI thread prio\n");
		}
	} else {
		NVT_ERR("controller is NULL\n");
	}
	...
	if (ts->pen_support) {
		...
		ts->pen_input_dev->hint_events_per_packet = 128; //improve evdev buffer size to 1024
...
//			msecs_to_jiffies(NVT_TOUCH_ESD_CHECK_PERIOD));
	...
	ts->nvt_lockdown_wq = alloc_workqueue("nvt_lockdown_wq", WQ_UNBOUND | WQ_MEM_RECLAIM, 1);
	if (!ts->nvt_lockdown_wq) {
...
//		goto err_create_nvt_lockdown_wq_failed;
	...
	// please make sure boot update start after display reset(RESX) sequence
//	queue_delayed_work(ts->nvt_lockdown_wq, &ts->nvt_lockdown_work, msecs_to_jiffies(5000));
	/* lockdown info read end*/
...
//	if(ret) {
//		NVT_ERR("register pen_connect_strategy state change notifier failed. ret=%d\n", ret);
...
//	xiaomitouch_register_modedata(&xiaomi_touch_interfaces);
	...
	if (ts->debugfs) {
		...
		debugfs_create_file("touch_debug", 0660, ts->debugfs, ts, &nvt_touch_test_fops);
	}
#endif
...
#ifdef CONFIG_TOUCHSCREEN_XIAOMI_TOUCHFEATURE
//the err after err_register_pen_charge_state_failed should be define in here
...
err_alloc_work_thread_failed:
	if (ts->nvt_lockdown_wq) {
		...
		destroy_workqueue(ts->nvt_lockdown_wq);
		ts->nvt_lockdown_wq = NULL;
	}
...
static int32_t nvt_ts_suspend(struct device *dev)
{
	...
	bTouchIsAwake = 0;
	/* gesture mode setup */
	if (ts->gesture_command & 0x01 || ts->gesture_command & 0x02) {
		...
		enable = (ts->gesture_command & 0x02);
		...
		NVT_LOG("%s off-screen shorthand gesture\n", enable ? "Enable" : "Disable");
	} else if (ts->gesture_command == 0) {
...
static int32_t nvt_ts_resume(struct device *dev)
{
	...
	update_pen_status(true);
	/* resume should setup power_supply mode again */
	ts->is_usb_exist = -1;
	queue_work(ts->event_wq, &ts->power_supply_work);
	...
	if (ts->gesture_command_delayed >= 0){
		...
		ts->gesture_command_delayed = -1;
		NVT_LOG("execute delayed command, set gesture mode %d\n", ts->gesture_command);
	}
	/* gesture mode setup end */
                 ...
                 struct xring_panel_event_notification *notification, void *client_data)
{
	...
	NVT_LOG("Notification type:%d, early_trigger:%d\n",
		notification->type, notification->data.early_trigger);

	switch (notification->type) {
	case DRM_PANEL_EVENT_UNBLANK:
		if (!bTouchIsAwake) {
			NVT_LOG("FB_BLANK_UNBLANK\n");
	...
	case DRM_PANEL_EVENT_FPS_CHANGE:
		if (notification->data.early_trigger) {
			...
			notification->data.old_fps, notification->data.new_fps);
		}
		break;
	default:
