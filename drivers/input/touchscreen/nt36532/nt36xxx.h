...
#define CONFIG_TOUCHSCREEN_SUPPORT_NEW_GAME_MODE
...
#define BOOT_UPDATE_FIRMWARE_NAME_FIRST "novatek_nt36532_m81_fw_tm.bin"
#define BOOT_UPDATE_FIRMWARE_NAME_SECOND "novatek_nt36532_m81_fw_csot.bin"
#define MP_UPDATE_FIRMWARE_NAME			"novatek_ts_mp.bin"
#define MP_UPDATE_FIRMWARE_NAME_FIRST   "novatek_nt36532_m81_mp_tm.bin"
#define MP_UPDATE_FIRMWARE_NAME_SECOND   "novatek_nt36532_m81_mp_csot.bin"
...
struct nvt_ts_data {
	...
	/* gesture mode setup */
	int gesture_command; /* bit0:db_wakeup bit1:off-screen shorthand */
	int ic_state;
